...
class AgentControl:
    ...
    def save_model(self, path):
        torch.save({
            'moving_policy_nn': self.moving_policy_nn.state_dict(),
            'moving_critic_nn': self.moving_critic_nn.state_dict(),
            'target_policy_nn': self.target_policy_nn.state_dict(),
            'target_critic_nn': self.target_critic_nn.state_dict(),
            'policy_optimizer': self.policy_nn_optim.state_dict(),
            'critic_optimizer': self.critic_nn_optim.state_dict()
        }, path)
